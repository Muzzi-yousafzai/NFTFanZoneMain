...
public class ObjectSelection : MonoBehaviour
{
    ...
    public GameObject ring;
     private void Awake()
     {
         gameObject.AddComponent<LeanTouch>().enabled = false;
         gameObject.AddComponent<LeanPinchScale>().enabled = false;
         gameObject.AddComponent<LeanTwistRotateAxis>().enabled = false;
         print("downloaded");
